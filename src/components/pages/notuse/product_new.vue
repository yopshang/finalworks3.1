<template>
    ...
    <div class="main-container">
        <!--nav-->
        <nav class="row navOnproduct ai-center "><!--ai-center-->
            <h2 class="titleIntop">
                <a class="titleIntop" href="/home.html">
                    CRAFTsMAN
                </a>
            </h2>
            <ul class="row ulOnnav mb-0">
                <li class="productList col-lg-3">Product</li>
                <li class="productList col-lg-3">Blog</li>
                <li class="productList col-lg-3">Blog</li>
                <li><i class="productList col-lg-3 fas fa-shopping-cart"></i></li>
            </ul>
        </nav>
        <!-- nav end -->
        <!-- product filter -->
        <div class="mb-3">  
            <div class="productFilter row ai-center">
                <ul class="productUl row mb-2 mt-2 col-lg-5">
                    <li class="animate__animated animate__headShake">ALL<sup>24</sup></li>
                    <li class="animate__animated animate__headShake">BOWL<sup>10</sup></li>
                    <li class="animate__animated animate__headShake">CUP<sup>8</sup></li>
                    <li class="animate__animated animate__headShake">PLATE<sup>3</sup></li>
                    <li class="animate__animated animate__headShake">VASE<sup>3</sup></li>
                </ul>
            </div>
        </div>
        <!-- product filter end -->
        ...
        <div class="mb-4 row">
            <!-- col1 -->
            <div class="col">
                <div data-aos="fade-down-right" class="">
                    <div>
                        <a href="/detail.html">
                ...
                <div  data-aos="fade-down" class="">
                    <div>
                        <a href="/detail.html">
                            ...
                            <div class="onsile2">ON SALE</div>
                            <section>
                                <h2 class="underOnsile2">Hana Vase</h2>
                                <div class="row col-lg-6 jc-space-around">
                                    <p>NT$3,600</p>
                                    <p class="text-dec">NT$3,880</p>
                                </div>
                            </section>
                        </a>
                    </div>
                ...
                <div  data-aos="fade-down-left" class="">
                    <div>
                        <a href="/detail.html">
                            ...
                            <div class="onsile2">ON SALE</div>
                            <section>
                                <h2 class="underOnsile2">Baifan Bowl</h2>
                                <div class="row col-lg-6 jc-space-around">
                                    <p>NT$1,800</p>
                                    <p class="text-dec">NT$1,980</p>
                                </div>
                            </section>
                        </a>
                    </div>
