<template>
    <div>
            <!-- second nav -->
            <h2 class="secNav mb-15"> <span class="secNavtitle1">填寫資訊</span><span class="secNavtitle3"> ></span> 建立訂單<span class="secNavtitle3"> > 完成購物!</span></h2>
            <!-- second nav end -->
            <!-- contact information -->
            <div>
                <h2></h2>
            ...
            <div>
                <div class="d-flex flex-wrap">
                    ...
                    <div class="d-flex w-100 jc-space-between mb-15">
                        <input class="p-15 w-50 mr-15" type="text" placeholder="Name">
                        <input class="p-15 w-50" placeholder="Phone" type="text">
                    </div>
